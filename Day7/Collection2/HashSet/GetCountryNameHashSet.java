/*Develop a java class with a instance variable H1 (HashSet) add a method saveCou ntryNames(String CountryName) ,
...
public class GetCountryNameHashSet {
	...
	public static void main(String[] args) {
		...
		GetCountryNameHashSet h= new GetCountryNameHashSet();
